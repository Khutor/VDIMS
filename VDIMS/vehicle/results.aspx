...
<asp:Content runat="server" ContentPlaceHolderID="contentMain">
    ...
    <asp:GridView ID="gvSearch" ShowHeaderWhenEmpty="true" runat="server" AllowPaging="True" CssClass= "table table-striped table-bordered table-condensed" AutoGenerateColumns="False">
        <Columns>
